...
tasks {
    ...
    val compileAssembly by registering(Exec::class) {
        description = "Compile the assembly code generated by the compiler"
        dependsOn(generateGrammarSource)
        commandLine("gcc", "-o", "output", "output.s", "helper.c")
    }

    val runTests by registering(Exec::class) {
        description = "Run the compiled assembly code and validate the output"
